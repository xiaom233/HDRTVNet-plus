...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='E:\dataset\Youtube_hdr\test_hdr', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='E:\dataset\Youtube_hdr\test_LaMa', help='Path to restored images')
