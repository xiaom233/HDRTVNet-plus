...
def create_dataset(dataset_opt):
    ...
    elif mode == 'LQGT_UNet_condition_dataset':
        from data.LQGT_UNet_condition_dataset import LQGT_dataset as D
    elif mode == 'LQGT_condition_mask_dataset':
        from data.LQGT_condition_mask_dataset import LQGT_dataset as D
    else:
